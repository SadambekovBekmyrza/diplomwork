...
import icon2 from "../../assets/iconYou.webp";
import icon3 from "../../assets/iconINST.webp";
import icon4 from "../../assets/iconTik.webp";
        ...
        <footer>
          <div className="average">
            <div className="boxfooter-1">
              ...
              2011 - 2023
              <br />© CCCSTORE.RU
              <div className="boxfooterbottom">
                <NavLink target="_blank" to="https://vk.com/cccstore">
                  <img src={icon1} alt="icon-VK" />
                </NavLink>
                <NavLink
                  target="_blank"
                  to="https://www.youtube.com/user/CCCstore"
                >
                  <img src={icon2} alt="icon-YouTube" />
                </NavLink>
                <NavLink
                  target="_blank"
                  to="https://www.instagram.com/cccstore.ru"
                >
                  <img src={icon3} alt="icon-Instagram" />
                </NavLink>
                <NavLink
                  target="_blank"
                  to="https://www.tiktok.com/@cccstore.ru"
                >
                  <img src={icon4} alt="icon-TikTok" />
                </NavLink>
              </div>
            </div>
            <div className="boxfooter-2">
              <h5>NAVIGATION</h5>
          ...
          <div className="footer-bottom">
            <ul className="nav-list">
              ...
              <li>
                <NavLink to="/category-list">Category</NavLink>
              </li>
            </ul>
          </div>
        </footer>
